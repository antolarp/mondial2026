    ...
    <html lang="fr">
      <body style={{ background: '#f0f2f8' }}>
        <header style={{
          ...
          <div className="nav-inner" style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px', height: 56, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <a href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none', flexShrink: 0 }}>
              ...
              />
              <span className="nav-brand-text" style={{ color: '#fff', fontWeight: 700, fontSize: 15, letterSpacing: '-0.3px' }}>
                Mondial 2026
            ...
            <nav className="nav-links" style={{ display: 'flex', gap: 24 }}>
              <a href="/" style={{ color: '#8aaad8', fontSize: 13, fontWeight: 500, textDecoration: 'none', letterSpacing: '0.02em' }}
                className="nav-link hover:text-white transition-colors">Classement</a>
              ...
              <a href="/groupes" style={{ color: '#8aaad8', fontSize: 13, fontWeight: 500, textDecoration: 'none', letterSpacing: '0.02em' }}
                className="nav-link hover:text-white transition-colors">Tournoi</a>
              ...
              <a href="/pronos" style={{ color: '#f0b429', fontSize: 13, fontWeight: 700, textDecoration: 'none', letterSpacing: '0.02em' }}
                className="nav-link hover:opacity-80 transition-opacity">🎯 Pronos</a>
            </nav>
          </div>
        </header>
        {children}
